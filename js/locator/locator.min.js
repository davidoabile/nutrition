...
!function () {
    ...
    Locator.defaultSearchSettings = {selectors: {map: ".loc-srch-res-map", list: ".loc-srch-res-list", teaser: ".loc-teaser", form: ".loc-srch-form", loader: ".loc-loader", trigger: ".loc-trigger", results: ".loc-srch-res"}, stickyMap: 0, baseUrl: "/"}, Locator.Form = Class.create({initialize: function (el, search) {
        ...
        if (this.el = el, this.defaults = {zoom: 15, scrollwheel: Locator.defaultSearchSettings.scrollwheel, mapTypeId: google.maps.MapTypeId.ROADMAP, mapTypeControl: !1, mapTypeControlOptions: {style: google.maps.MapTypeControlStyle.HORIZONTAL_BAR, position: google.maps.ControlPosition.BOTTOM_CENTER, mapTypeIds: [google.maps.MapTypeId.ROADMAP, "locator"]}, streetViewControl: !1, streetViewControlOptions: {position: google.maps.ControlPosition.LEFT_TOP}}, this.map = new google.maps.Map(el, this.defaults), this.markers = [], this.infowindows = [], this.stoppers = [], this.settings = {maxZoom: 15, baseUrl: Locator.defaultSearchSettings.baseUrl, markerIcon: "M25,0C11.191,0,0,11.194,0,25c0,23.87,25,55,25,55s25-31.13,25-55C50,11.194,38.807,0,25,0z M25,38.8c-7.457,0-13.5-6.044-13.5-13.5S17.543,11.8,25,11.8c7.455,0,13.5,6.044,13.5,13.5S32.455,38.8,25,38.8z", markerColour: Locator.defaultSearchSettings.markerColour, crosshairIcon: "M27.5,56.738V62h9v-5.307c10.207-1.9,18.24-9.968,20.09-20.193h5.16v-9h-5.16C54.74,17.275,46.707,9.208,36.5,7.307V2h-9v5.262C17.174,9.077,9.025,17.192,7.16,27.5H2v9h5.16C9.025,46.808,17.174,54.923,27.5,56.738z M31.875,13.875C41.869,13.875,50,22.006,50,32c0,9.994-8.131,18.125-18.125,18.125S13.75,41.994,13.75,32C13.75,22.006,21.881,13.875,31.875,13.875z"}, theme) {
        ...
        for (var key in map.markers)if (map.markers.hasOwnProperty(key)) {
            ...
            map.map.getBounds().contains(marker.getPosition()) ? (teaser && teaser.removeClassName("is-hidden"), marker.setVisible(!0)) : (teaser && !teaser.hasClassName("loc-closest") && teaser.addClassName("is-hidden"), marker.setVisible(!1))
        }
        return this
