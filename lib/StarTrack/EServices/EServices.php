...
class EServices {
   ...
   /**
     *
     * @var \StarTrack\StarTrack $starTrack StarTrack object
     */
...
//		'trace' => true,
            ...
            $oClient = (new WSSoapClient($connection['wsdl'], $clientArguments))->setStarTrack($this->starTrack);
    ...
    /**
      ...
      * 
      * @return mixed|string  Description string (e.g. 'UNSERVICEABLE'), or "" if not found
     */ 
