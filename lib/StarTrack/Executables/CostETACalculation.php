...
/*   <document_root>/MyWebSite/CostETACalculation.php
     Sample application invoking calculateCost, a StarTrack eService operation
     StarTrack
     8 August 2012
     Version 4.4 
*/
...
<table width="600" border="0">
  ...
  <tr>
    ...
    <td align="left"><input type="text" name="postCodeSender" />&nbsp;</td>
    <td align="left"><input type="text" name="stateSender" />&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td align="left"><input type="text" name="postCodeReceiver" />&nbsp;</td>
   <td align="left"><input type="text" name="stateReceiver" />&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    <th scope="row" align="left">Include Transit Warranty?&nbsp;</th>
    <td align="left"><input id="includeTransitWarranty" type="text" name="includeTransitWarranty" />&nbsp;</td>
  </tr>
  <tr>
    <th scope="row" align="left">Transit Warranty Value&nbsp;</th>
    <td align="left"><input type="text" name="transitWarrantyValue" />&nbsp;</td>
  </tr>
  <tr>
    <th scope="row" align="left">Include Fuel Surcharge?&nbsp;</th>
    <td align="left"><input id="includeFuelSurcharge" type="text" name="includeFuelSurcharge" />&nbsp;</td>
  </tr>
  <tr>
    <th scope="row" align="left">Despatch Date&nbsp;</th>
    <td align="left"><input type="text" name="despatchDate" value="2011-06-25"/>&nbsp;</td>
  </tr>
</table>
<br />
