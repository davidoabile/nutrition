...
class Varien_Data_Form_Element_Date extends Varien_Data_Form_Element_Abstract
{
    ...
    public function getElementHtml()
    {
        ...
        if (Mage::getStoreConfigFlag('moogento_clean/css/main_part') && Mage::getStoreConfig('moogento_clean/general/theme') == 'extended') {
            $this->addClass('input-text');

            $outputFormat = str_replace(array("mm","m","M"), "MM", str_replace(array("d","D","DD"), "dd", $this->getFormat()));
            ...
            $html .= '<script type="text/javascript">'
                ...
                pickTime: ' . ($this->getTime() ? 'true' : 'false')
                . '});});'
                . '</script>';
