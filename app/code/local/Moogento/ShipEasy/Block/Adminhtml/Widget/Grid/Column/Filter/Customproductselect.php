...
class Moogento_ShipEasy_Block_Adminhtml_Widget_Grid_Column_Filter_Customproductselect extends Mage_Adminhtml_Block_Widget_Grid_Column_Filter_Select
{
    ...
    {
        $attribute_code = Mage::getStoreConfig('moogento_shipeasy/grid/szy_custom_product_attribute_inside');
