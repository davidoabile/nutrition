...
class Moogento_Core_Block_Adminhtml_System_Config_Countrytemplate extends Mage_Adminhtml_Block_Widget implements
    Varien_Data_Form_Element_Renderer_Interface
{
    ...
    protected function _getJson()
    {
        ...
        $templates = Mage::getModel("moogento_core/countrytemplate")->getCollection()->setOrder('sort_number', 'ASC');
