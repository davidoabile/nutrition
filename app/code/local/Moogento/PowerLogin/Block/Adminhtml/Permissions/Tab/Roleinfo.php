 ...
 *
 */
class Moogento_PowerLogin_Block_Adminhtml_Permissions_Tab_Roleinfo extends Mage_Adminhtml_Block_Permissions_Tab_Roleinfo
{
    ...
    {   
        ...
        $fieldset->addField('home_page', 'select', array(
            ...
            'value' => $this->getRole()->getData('home_page'),
        ));
