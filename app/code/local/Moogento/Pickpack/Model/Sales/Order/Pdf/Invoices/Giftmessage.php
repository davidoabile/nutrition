...
//         Mage::log(memory_get_usage(),'null','moogento_pickpack.log');
        ...
        $this->_printing_format['background_color_gift_message'] = trim($this->_getConfig('background_color_gift_message', '#5BA638', false, 'general', $store_id));
        ...
        $this->_printing_format['background_color_gift_message_zend'] = new Zend_Pdf_Color_Html('' .  $this->_printing_format['background_color_gift_message'] . '');
	...
	protected function printProductGiftMessage($page, $order, $item, $gift_message_yn, $message_title_tofrom_yn, $product_gift_message_yn, $max_chars_message,$max_width_gift_message, $msgX){
		...
		$background_color_temp = $this->_printing_format['background_color_gift_message_zend'];
		$background_color_gift_message = $this->_printing_format['background_color_gift_message'];
			...
			if ($item_gift_message['has_message'] == 1) {
				...
				if ($product_gift_message_yn != 0) {
					...
					if (($this->y - $temp_height) < 10 && count($gift_msg_array) > 0) {
						...
						$paging_text_width = widthForStringUsingFontSize($paging_text, $font_family_subtitles, ($font_size_subtitles - 2));
    ...
    protected function printOrderGiftMessage($page, $order,$gift_message_yn, $message_title_tofrom_yn,$max_chars_message,$max_width_gift_message, $msgX){
		...
		if($gift_message != ''){
			...
			$this->y = $this->drawOrderGiftMessage($gift_msg_array, $msgX + 4, $font_size_temp, $this->y, $page);
