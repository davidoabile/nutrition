            	...
            	// [column_attribute] %ship_firstname% %ship_lastname%
						...
						{	
							...
							if(count($attribute_arr) > 1)
							{
								...
								$csv_output .= $field_quotes . $column_attribute2 . $field_quotes . $column_separator;
							}
							//Single attribute
							else
							{
								...
								$csv_output .= $field_quotes . $row[$order_id][$attribute_base] . $field_quotes . $column_separator;
							}
						 }					
