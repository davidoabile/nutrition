    ...
    extends Mage_Adminhtml_Block_System_Config_Form_Fieldset
{
    ...
    protected function _getFieldsContainerHeader($title)
    {
		...
		{
			$html = '<tr><td colspan="' . $colspan . '" style="color:#ff0000">To access "Automated Action group" please install <b><a href="https://www.moogento.com/magento-order-shipping-processing.html" target="_blank">shipEasy</a></b></td></tr>';
     ...
     protected function _getFieldsContainerHeaderNoneborder($title)
    {
		...
		if(!$isShipEasyInstalled)
		{
			//$html = '<tr><td colspan="' . $colspan . '" style="color:#ff0000">To access "Automatic Action group" please install <b><a href="https://www.moogento.com/magento-order-shipping-processing.html" target="_blank">shipEasy</a></b></td></tr>';
        	$html .= '<tr style="display:none"><td colspan="' . $colspan . '">';
        }
        else
        {
