	...
	extends Mage_Adminhtml_Block_Abstract implements Varien_Data_Form_Element_Renderer_Interface
{
	...
	public function render(Varien_Data_Form_Element_Abstract $element)
	{
		...
		$url1 = $this->getUrl('adminhtml/dataporter_cfgporter/index/action_type/import/package/' . $elementData['package']);
		$url2 = $this->getUrl('adminhtml/dataporter_cfgporter/index/action_type/export/package/' . $elementData['package']);
