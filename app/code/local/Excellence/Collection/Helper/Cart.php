...
require_once "Mage/Checkout/Helper/Cart.php";
class Excellence_Collection_Helper_Cart extends Mage_Checkout_Helper_Cart
{
    /**
     * XML path for redirect to cart value
     */
    const XML_PATH_REDIRECT_TO_CART = 'collection/cart/redirect_to_cart';
    ...
    public function getAddUrl($product, $additional = array())
    {
        ...
        return $this->_getUrl('collection/cart/add', $routeParams);
    }
    ...
    public function getRemoveUrl($item)
    {
        ...
        return $this->_getUrl('collection/cart/delete', $params);
    }
    ...
    {
        return $this->_getUrl('collection/cart');
    }
    ...
    {
        return Mage::getSingleton('collection/session')->getQuote();
    }
