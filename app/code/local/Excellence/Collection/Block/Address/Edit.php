 ...
 */
require_once 'Mage/Customer/Block/Address/Edit.php';
class Excellence_Collection_Block_Address_Edit extends Mage_Customer_Block_Address_Edit
{
    protected $_address;
    ...
    public function getSaveUrlforcheckout()
    {
        return Mage::getUrl('collection/address/formPost', array('_secure'=>true, 'id'=>$this->getAddress()->getId()));
    }
