...
class Wyomind_Ordersexporttool_Block_Adminhtml_Profiles_Renderer_Action extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Action
{
	public function render(Varien_Object $row)
	{
		...
		array(
		            'url'     => $this->getUrl('*/profiles/edit', array('id' => $row->getFile_id())),
		            'caption' => Mage::helper('ordersexporttool')->__('Edit'),
		),
		array(
		            'url'     => $this->getUrl('*/profiles/delete', array('id' => $row->getFile_id())),
		...
		array(
		            'url'     => $this->getUrl('*/profiles/sample', array('file_id' => $row->getFile_id(), 'limit'=>10)),
		...
		array(
		            'url'     => $this->getUrl('*/profiles/generate', array('file_id' => $row->getFile_id())),
