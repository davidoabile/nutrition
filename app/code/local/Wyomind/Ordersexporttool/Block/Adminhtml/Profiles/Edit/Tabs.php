...
class Wyomind_Ordersexporttool_Block_Adminhtml_Profiles_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs {
    ...
    protected function _beforeToHtml() {
        ...
        $this->addTab('form_filter', array(
            'label' => $this->__('Advanced filters'),
            'title' => $this->__('Advanced filters'),
            'content' => $this->getLayout()
...
//        ));
        ...
        $this->addTab('form_output', array(
            'label' => $this->__('Output settings'),
            'title' => $this->__('Output settings'),
            'content' => $this->getLayout()
                    ->createBlock('ordersexporttool/adminhtml_profiles_edit_tab_output')
                    ->toHtml()
        ));
