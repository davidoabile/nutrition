...
class Wyomind_Ordersexporttool_Block_Adminhtml_Profiles_Edit_Tab_Configuration extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $fieldset->addField('file_repeat_for_each', 'select', array(
            'label' => Mage::helper('ordersexporttool')->__('Create one file for each order'),
        ...
        $fieldset = $form->addFieldset('ordersexporttool_form_3', array('legend' => $this->__('Products to export')));
...
//        $fieldset->addField('file_product_filter', 'select', array(
//            'label' => 'Product assignation',
//            'name' => 'file_product_filter',
//            'values' => array(
//                array('value' => '0', 'label' => $this->__('All products')),
//                array('value' => '1', 'label' => $this->__('Only products assigned to this profile')),
//                array('value' => '2', 'label' => $this->__('All products not assigned to this profile')),
//                array('value' => '3', 'label' => $this->__('All products not assigned to any profile')),
//            ),
//            'disabled' => false,
//        ));


        $fieldset = $form->addFieldset('ordersexporttool_form_2', array('legend' => $this->__('Orders to export')));
        ...
        $fieldset->addField('file_flag', 'select', array(
            'label' => Mage::helper('ordersexporttool')->__('Mark each exported order'),
            'name' => 'file_flag',
            'values' => array(
                array(
                    'value' => 0,
