...
class Tatva_Catalogextensions_IndexController extends Mage_Core_Controller_Front_Action
{
    ...
    public function weeklyAction()
    {
        ...
        {
            $this->loadLayout();
            $this->getLayout()->getBlock('head')->setTitle('Weekly Special');
            $this->renderLayout();
        }
    }
	public function bestsellersAction()
    {
		...
		{
		$this->loadLayout(); 
		$this->getLayout()->getBlock('head')->setTitle('Bestsellers');    
		$this->renderLayout();
		}
    }
	...
	public function mostviewedAction()
    {
		...
		$this->loadLayout(); 
		$this->getLayout()->getBlock('head')->setTitle('Most viewed products');    
		$this->renderLayout();
    }
