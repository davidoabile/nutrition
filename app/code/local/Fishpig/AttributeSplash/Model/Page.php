...
class Fishpig_AttributeSplash_Model_Page extends Fishpig_AttributeSplash_Model_Abstract
{
	...
	{
		return Mage::helper('cms')->getBlockTemplateProcessor()->filter($this->getData('promo_block'));
	}
	...
	{
		return Mage::helper('attributeSplash/image')->getImageUrl($this->getData('image_hover'));
	}
	...
	public function getThumbnailHover()
	{
		return Mage::helper('attributeSplash/image')->getImageUrl($this->getData('thumbnail_hover'));
	}
