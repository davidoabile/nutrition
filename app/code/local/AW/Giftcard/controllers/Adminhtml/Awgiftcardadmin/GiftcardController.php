...
class AW_Giftcard_Adminhtml_Awgiftcardadmin_GiftcardController extends Mage_Adminhtml_Controller_Action
{
    protected function _isAllowed()
    {
        return Mage::getSingleton('admin/session')->isAllowed('customer/aw_giftcard/manage');
    }
