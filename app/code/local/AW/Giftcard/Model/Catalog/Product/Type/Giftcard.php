...
class AW_Giftcard_Model_Catalog_Product_Type_Giftcard extends Mage_Catalog_Model_Product_Type_Abstract
{
    ...
    protected function _prepareProduct(Varien_Object $buyRequest, $product, $processMode)
    {
        ...
        $product->addCustomOption('aw_gc_postal_firstname', $buyRequest->getAwGcPostalFirstname(), $product);
        $product->addCustomOption('aw_gc_postal_lastname', $buyRequest->getAwGcPostalLastname(), $product);
        $product->addCustomOption('aw_gc_postal_address', $buyRequest->getAwGcPostalAddress(), $product);
        $product->addCustomOption('aw_gc_postal_suburb', $buyRequest->getAwGcPostalSuburb(), $product);
        $product->addCustomOption('aw_gc_postal_country', $buyRequest->getAwGcPostalCountry(), $product);
        $product->addCustomOption('aw_gc_postal_state', $buyRequest->getAwGcPostalState(), $product);
        $product->addCustomOption('aw_gc_postal_postcode', $buyRequest->getAwGcPostalPostcode(), $product);
        $product->addCustomOption('aw_gc_postal_phone', $buyRequest->getAwGcPostalPhone(), $product);
    ...
    public function processBuyRequest($product, $buyRequest)
    {
        $options = array(
            ...
            'aw_gc_postal_firstname'         => $buyRequest->getAwGcPostalFistname(),
            'aw_gc_postal_lastname'         => $buyRequest->getAwGcPostalLastname(),
            'aw_gc_postal_address'         => $buyRequest->getAwGcPostalAddress(),
            'aw_gc_postal_suburb'         => $buyRequest->getAwGcPostalSuburb(),
            'aw_gc_postal_country'         => $buyRequest->getAwGcPostalCountry(),
            'aw_gc_postal_state'         => $buyRequest->getAwGcPostalState(),
            'aw_gc_postal_postcode'         => $buyRequest->getAwGcPostalPostcode(),
            'aw_gc_postal_phone'         => $buyRequest->getAwGcPostalPhone()
