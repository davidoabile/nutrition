...
class AW_Giftcard_Model_Email_Template extends Ebizmarts_Mandrill_Model_Email_Template
{
    ...
    public function prepareEmailAndSend(array $variables, $store)
    {
        ...
        if (array_key_exists('aw_gc_postal_firstname', $variables)) {
            $templateData['aw_gc_postal_firstname'] = $variables['aw_gc_postal_firstname'];
        }
        if (array_key_exists('aw_gc_postal_lastname', $variables)) {
            $templateData['aw_gc_postal_lastname'] = $variables['aw_gc_postal_lastname'];
        }
        if (array_key_exists('aw_gc_postal_address', $variables)) {
            $templateData['aw_gc_postal_address'] = $variables['aw_gc_postal_address'];
        }
        if (array_key_exists('aw_gc_postal_suburb', $variables)) {
            $templateData['aw_gc_postal_suburb'] = $variables['aw_gc_postal_suburb'];
        }
        if (array_key_exists('aw_gc_postal_country', $variables)) {
            $templateData['aw_gc_postal_country'] = $variables['aw_gc_postal_country'];
        }
        if (array_key_exists('aw_gc_postal_state', $variables)) {
            $templateData['aw_gc_postal_state'] = $variables['aw_gc_postal_state'];
        }
        if (array_key_exists('aw_gc_postal_postcode', $variables)) {
            $templateData['aw_gc_postal_postcode'] = $variables['aw_gc_postal_postcode'];
        }
        if (array_key_exists('aw_gc_postal_phone', $variables)) {
            $templateData['aw_gc_postal_phone'] = $variables['aw_gc_postal_phone'];
        }
