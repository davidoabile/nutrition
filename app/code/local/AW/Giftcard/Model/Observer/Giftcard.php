...
class AW_Giftcard_Model_Observer_Giftcard extends Mage_Core_Model_Abstract
{
    ...
    public function convertQuoteItemToOrderItem(Varien_Event_Observer $observer)
    {
        ...
        $giftCardOptions = array(
            ...
            'aw_gc_message',
            'aw_gc_postal_firstname',
            'aw_gc_postal_lastname',
            'aw_gc_postal_address',
            'aw_gc_postal_suburb',
            'aw_gc_postal_country',
            'aw_gc_postal_state',
            'aw_gc_postal_postcode',
            'aw_gc_postal_phone',
        );
    ...
    public function salesOrderSaveAfter(Varien_Event_Observer $observer)
    {
        ...
        foreach ($order->getAllItems() as $item) {
            ...
            if (true === $codeErrorFlag) {
                $url = Mage::getSingleton('adminhtml/url')->getUrl('adminhtml/awgiftcardadmin_giftcard');
