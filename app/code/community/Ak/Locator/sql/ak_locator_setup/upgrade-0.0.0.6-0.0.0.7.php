...
$installer->addAttribute(Ak_Locator_Model_Location::ENTITY, 'stockist_phone', array(
    'input'         => 'text',
    'type'          => 'varchar',
    'label'         => 'Phone',
    'user_defined'  => false,
...
$installer->addAttribute(Ak_Locator_Model_Location::ENTITY, 'fax', array(
    'input'         => 'text',
    'type'          => 'varchar',
    'label'         => 'Fax',
    'user_defined'  => false,
...
$installer->addAttribute(Ak_Locator_Model_Location::ENTITY, 'overview', array(
    'input'         => 'textarea',
    'type'          => 'text',
    'label'         => 'Overview',
    'user_defined'  => false,
...
$installer->addAttribute(Ak_Locator_Model_Location::ENTITY, 'trading_hours', array(
    'input'         => 'textarea',
    'type'          => 'text',
    'label'         => 'Trading Hours',
    'user_defined'  => false,
