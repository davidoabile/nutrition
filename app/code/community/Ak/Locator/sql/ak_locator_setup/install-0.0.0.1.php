...
/*$installer->run("DROP TABLE IF EXISTS {$installer->getTable('ak_locator/location')};");
$installer->run("DROP TABLE IF EXISTS {$installer->getTable('ak_locator/eav_attribute')};");
$installer->run("DROP TABLE IF EXISTS {$installer->getTable('ak_locator/eav_attribute_website')};");
$installer->run("DROP TABLE IF EXISTS {$installer->getTable('ak_locator/form_attribute')};");
$installer->run("DROP TABLE IF EXISTS {$installer->getTable('ak_locator/location_entity_varchar')};");
$installer->run("DROP TABLE IF EXISTS {$installer->getTable('ak_locator/location_entity_int')};");
$installer->run("DROP TABLE IF EXISTS {$installer->getTable('ak_locator/location_entity_text')};");
$installer->run("DROP TABLE IF EXISTS {$installer->getTable('ak_locator/location_entity_datetime')};");*/
