...
class Onibi_StoreLocator_Block_Adminhtml_Store_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
	...
	$fieldset->addField('state', 'text', array(
            'label'     => Mage::helper('onibi_storelocator')->__('State'),
            'class'     => 'required-entry',
            'required'  => true,
            'name'      => 'state',
            'onchange'    => 'getLatLng()',
        ...
        $fieldset->addField('email', 'text', array(
            'label'     => Mage::helper('onibi_storelocator')->__('Email'),
            'name'      => 'email',
        ));
        ...
        $fieldsetManager = $form->addFieldset('onibi_storelocator_form_manager', array(
            'legend'    => Mage::helper('checkout')->__('Manager Info')
        ));
 	$fieldsetManager ->addField('manager_name', 'text', array(
            'label'     => Mage::helper('onibi_storelocator')->__('Manager Name'),
            'required'  => true,
            'name'      => 'manager_name',
        ));
        $fieldsetManager ->addField('manager_desc', 'textarea', array(
            'label'     => Mage::helper('onibi_storelocator')->__('Manager Description'),
            'name'      => 'manager_desc',
        ));
        
        $fieldsetManager ->addField('manager_image', 'image', array(
            'label'     => Mage::helper('onibi_storelocator')->__('Manager Image'),
            'required'  => false,
            'name'      => 'manager_image',
        ));
