 ...
 */
class Belvg_ProductZoomLight_Block_Adminhtml_Config_Info extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    const MODULE_NAME = 'Belvg_ProductZoomLight';

    public function render(Varien_Data_Form_Element_Abstract $element)
    {
        $helper = Mage::helper('productzoomlight');
