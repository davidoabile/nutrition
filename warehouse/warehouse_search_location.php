...
WHERE `catalog_product_entity_varchar`.`entity_id` = (
    ...
    WHERE `catalog_product_entity_varchar`.`attribute_id` = 820 
    and `catalog_product_entity_varchar`.`value` = '$term'
	LIMIT 0 , 1
	) 
and `cataloginventory_stock_item`.`product_id` = `catalog_product_entity_varchar`.`entity_id` 
and (`catalog_product_entity_varchar`.`attribute_id` = 71 or `catalog_product_entity_varchar`.`attribute_id` = 820 
or `catalog_product_entity_varchar`.`attribute_id` = 823)"; 
...
<!--
<a href="https://www.nutritionwarehouse.com.au/warehouse/warehouse_search_detailed.php">Detailed Search</a>
&nbsp;&nbsp;&nbsp;&nbsp;
-->
