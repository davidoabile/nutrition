...
$j(document).ready(function () {
    ...
    if (isResponsive)
    {
        ...
        {
            if (typeof enquire != 'undefined') enquire.register('screen and (max-width: ' + (breakpointMedium - 1) + 'px)', {
                match: function () {
    ...
    if (isResponsive)
    {
        if (typeof enquire != 'undefined') enquire.register('(max-width: ' + (breakpointMedium - 1) + 'px)', {
            setup: function () {
